...
#[async_trait]
impl TypedTransform<DocumentState, NodeState> for TokenTextSplitter {
    ...
    fn description(&self) -> &'static str {
        "Splits documents into chunks based on raw token counts with precise token limit control"
    }
}

// Legacy Transform implementation has been removed.
// TokenTextSplitter now only uses the type-safe TypedTransform system.
