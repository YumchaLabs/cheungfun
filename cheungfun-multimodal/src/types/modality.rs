...
impl MediaFormat {
    ...
    pub fn modality_type(&self) -> ModalityType {
        match self {
            ...
            | Self::Bmp | Self::Tiff | Self::Ico => ModalityType::Image,
            
            Self::Mp3 | Self::Wav | Self::Flac | Self::Ogg | Self::M4a 
            | Self::Aac | Self::Wma => ModalityType::Audio,
            
            Self::Mp4 | Self::Avi | Self::Mkv | Self::WebM | Self::Mov 
            | Self::Wmv | Self::Flv => ModalityType::Video,
            
            Self::Pdf | Self::Docx | Self::Doc | Self::Pptx | Self::Ppt 
            | Self::Xlsx | Self::Xls | Self::Odt | Self::Rtf => ModalityType::Document,
            
            Self::PlainText | Self::Markdown | Self::Html | Self::Xml 
            | Self::Json | Self::Yaml | Self::Csv => ModalityType::Text,
...
mod tests {
    ...
    fn test_modality_type_from_str() {
        ...
        assert_eq!("IMAGE".parse::<ModalityType>().unwrap(), ModalityType::Image);
