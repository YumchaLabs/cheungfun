...
use crate::types::{media::MediaContent, modality::ModalityType};
...
impl MultimodalDocument {
    ...
    pub fn with_media(base: Document, modality: ModalityType, media: MediaContent) -> Self {
        Self {
            base,
...
impl MultimodalNode {
    ...
    pub fn with_media(base: Node, modality: ModalityType, media: MediaContent) -> Self {
        Self {
            base,
            modality,
            media_content: Some(media),
...
impl MultimodalNodeBuilder {
    ...
    pub fn build(self) -> anyhow::Result<MultimodalNode> {
        let base = self
            .base
            .ok_or_else(|| anyhow::anyhow!("Base node is required"))?;
...
mod tests {
    ...
    fn test_multimodal_node_builder() {
        ...
        assert_eq!(
            multimodal_node.get_embedding("clip"),
