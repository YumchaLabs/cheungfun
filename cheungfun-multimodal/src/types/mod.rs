...
pub use media::{MediaContent, MediaData, MediaMetadata, MediaContentBuilder};
pub use modality::{ModalityType, MediaFormat};
...
pub mod utils {
    ...
    pub fn are_modalities_compatible(source: ModalityType, target: ModalityType) -> bool {
        match (source, target) {
            ...
            (ModalityType::Image, ModalityType::Video) | (ModalityType::Video, ModalityType::Image) => true,
            (ModalityType::Image, ModalityType::Document) | (ModalityType::Document, ModalityType::Image) => true,
            (ModalityType::Video, ModalityType::Document) | (ModalityType::Document, ModalityType::Video) => true,
            
            // Audio and video are compatible (video contains audio)
            (ModalityType::Audio, ModalityType::Video) | (ModalityType::Video, ModalityType::Audio) => true,
...
mod tests {
    ...
    fn test_modality_detection() {
        assert_eq!(detect_modality_from_extension("jpg"), Some(ModalityType::Image));
        assert_eq!(detect_modality_from_extension("mp3"), Some(ModalityType::Audio));
        assert_eq!(detect_modality_from_extension("mp4"), Some(ModalityType::Video));
        assert_eq!(detect_modality_from_extension("pdf"), Some(ModalityType::Document));
        assert_eq!(detect_modality_from_extension("txt"), Some(ModalityType::Text));
    ...
    fn test_modality_compatibility() {
        assert!(are_modalities_compatible(ModalityType::Text, ModalityType::Image));
        assert!(are_modalities_compatible(ModalityType::Image, ModalityType::Video));
        assert!(are_modalities_compatible(ModalityType::Audio, ModalityType::Video));
        assert!(!are_modalities_compatible(ModalityType::Image, ModalityType::Audio));
    }
